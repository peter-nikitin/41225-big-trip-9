  ...
  <header class="event__header">
    <div class="event__type-wrapper">
      <label class="event__type  event__type-btn" for="event-type-toggle-1">
        ...
        <img class="event__type-icon" width="17" height="17" src="img/icons/${action.name.toLowerCase()}.png" alt="Event type icon">
      </label>
        ...
        ${Object.keys(activity).map((ActivityType) => `
          <fieldset class="event__type-group">
            ...
            <div class="event__type-item">
              ...
              ${(currentActivity === action.name) ? `checked` : ``}
              >
    ...
    <div class="event__field-group  event__field-group--destination">
      ...
      ${action.name} ${(action.name === `transfer`) ? `to` : `at`} 
      </label>
